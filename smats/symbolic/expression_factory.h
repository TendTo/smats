...
class ExpressionMulFactory {
 public:
  ...
  ExpressionMulFactory<T> &add(const T &o);
  ExpressionMulFactory<T> &add(const Expression<T> &o);
  ExpressionMulFactory<T> &add(const std::shared_ptr<ExpressionCell<T>> &o);
  ExpressionMulFactory<T> &add(const ExpressionCell<T> &o);
  ExpressionMulFactory<T> &add(const T &constant, const ExpressionMap &expr_to_coeff_map);
  ExpressionMulFactory<T> &add(const T &constant, const Expression<T> &expr);
